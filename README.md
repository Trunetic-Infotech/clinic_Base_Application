...
```bash
git remote add upstream https://github.com/Trunetic-Infotech/clinic_Base_Application.git
```
...
```
origin    https://github.com/your-username/Ti-EduCore_Dev_Improve.git (fetch)
origin    https://github.com/your-username/Ti-EduCore_Dev_Improve.git (push)
upstream  https://github.com/Trunetic-Infotech/clinic_Base_Application.git (fetch)
upstream  https://github.com/Trunetic-Infotech/clinic_Base_Application.git (push)
```
